...
from qiskit import quantum_info  #opflow
...
def apply_encoding(operator, encoding, output_format = 'openfermion'):
    ...
    #---- Change ----
    #We hope that the operator doesn't have this type
    # if type(operator) == quantum_info.PauliSumOp:
    #     operator = PauliSumOp_to_QubitOperator(operator)

    #We save the operator before
    operator0 = operator

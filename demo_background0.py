...
def compute_now(name_mol, nlayers, CAS_user, geometry, maxiter_vals, read_hams, computational_style: int = 0, options_runtime = None, backend=None, session=None, init_params:list = None):
  '''

...
with st.sidebar:
    ...
    with container1:
        ...
        st.markdown(titulo, unsafe_allow_html=True, help="Una sola distancia: Se grafica el proceso de convergencia con el algoritmo VQE para esta sola distancia.", help="Un rango de distancias: Se grafica la energía en función de la distancia entre los átomos de la molécula.")
